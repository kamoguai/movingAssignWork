import 'package:assignwork/bloc/bookingStatusType2_bloc.dart';
...
///完工查詢tab頁
///Date: 2019-10-17
class BookingStatusType2Page extends StatefulWidget {

  @override
  BookingStatusType2PageState createState() => BookingStatusType2PageState();
}

class BookingStatusType2PageState extends State<BookingStatusType2Page> with AutomaticKeepAliveClientMixin<BookingStatusType2Page> {

  ///約裝查詢事件相關
  final BookingStatusType2Bloc bloc = new BookingStatusType2Bloc();
  ...
  _renderItem(prefix0.CustomerWorkOrderInfos c) {
    ...
    return BookingStatusItem(model: model, bookingType: "2", accNo: _getStore().state.userInfo?.accNo, accName: _getStore().state.userInfo?.empName, deptId: _getStore().state.userInfo?.deptCD,);
  }
