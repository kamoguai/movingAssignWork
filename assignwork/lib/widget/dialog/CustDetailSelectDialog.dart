...
class _CustDetailSelectDialogState extends State<CustDetailSelectDialog>
    with BaseWidget {
  ///地址地區arr
  ...
  ///記錄全路段
  Map<String, dynamic> logFullAddress = {
    "city": "新北市",
    "area": "板橋區",
    "areaCode": "220/ROOT",
    "road": "",
            ...
            toolbarButtons: [
              (node) {
                return InkWell(
                  onTap: () {
                    _fieldFoucusChange(
                        context, _mobileFocus, _telAreaCodeFocus);
                  },
                  child: Container(
                    padding: EdgeInsets.all(5),
                    child: autoTextSize(
                        '完成', TextStyle(color: Colors.black), context),
                  ),
                );
              }
            ],
            ...
            toolbarButtons: [
              (node) {
                return InkWell(
                  onTap: () {
                    _fieldFoucusChange(
                        context, _telAreaCodeFocus, _telPhoneFocus);
                  },
                  child: Container(
                    padding: EdgeInsets.all(5),
                    child: autoTextSize(
          ...
          KeyboardAction(
            ...
            toolbarButtons: [
              (node) {
                return InkWell(
                  onTap: () {
                    _fieldFoucusChange(context, _floorFocus, _floorOfFocus);
                  },
                  child: Container(
                    padding: EdgeInsets.all(5),
                    child: autoTextSize(
  ...
  _postMatchAddress() async {
    ...
    paramMap2["community"] =
        _communityController.text.length == 0 ? "0" : _communityController.text;
    paramMap2["lane"] =
        _laneController.text.length == 0 ? "0" : _laneController.text;
    paramMap2["unit"] =
        _unitController.text.length == 0 ? "0" : _unitController.text;
    paramMap2["ofUnit"] =
        _ofUnitController.text.length == 0 ? "0" : _ofUnitController.text;
    paramMap2["floor"] =
        _floorController.text.length == 0 ? "0" : _floorController.text;
    paramMap2["floorOf"] =
        _floorOfController.text.length == 0 ? "0" : _floorOfController.text;
    ...
    if (res.result) {
      setState(() {
        ...
        this.logFullAddress["buildingName"] =
            res.data["InstallAddressBuildingName"];
        _appendFullData();
  ...
  _appendFullData() {
    ...
    var fullAddr =
        "${this.logFullAddress["city"]}${this.logFullAddress["area"]}${this.logFullAddress["road"]}";
  ...
  void initData() {
    ...
    if (widget.logMatchAddr.length > 0) {
      _nameController.value =
          TextEditingValue(text: widget.logMatchAddr["custName"] ?? "");
      _mobileController.value =
          TextEditingValue(text: widget.logMatchAddr["mobile"] ?? "");
      _telAreaCodeController.value =
          TextEditingValue(text: widget.logMatchAddr["telAreaCode"] ?? "");
      _telPhoneController.value =
          TextEditingValue(text: widget.logMatchAddr["telPhone"] ?? "");
      _communityController.value =
          TextEditingValue(text: widget.logMatchAddr["community"] ?? "");
      _laneController.value =
          TextEditingValue(text: widget.logMatchAddr["lane"] ?? "");
      _unitController.value =
          TextEditingValue(text: widget.logMatchAddr["unit"] ?? "");
      _ofUnitController.value =
          TextEditingValue(text: widget.logMatchAddr["ofUnit"] ?? "");
      _floorController.value =
          TextEditingValue(text: widget.logMatchAddr["floor"] ?? "");
      _floorOfController.value =
          TextEditingValue(text: widget.logMatchAddr["floorOf"] ?? "");
        ...
        child: Row(
          ...
          children: <Widget>[
            autoTextSize(
                ...
                TextStyle(
                    color: Colors.black,
                    fontSize: MyScreen.normalPageFontSize(context) * 1.5),
                context),
            GestureDetector(
              child: Icon(
                Icons.cancel,
                color: Colors.white,
                size: titleHeight(context) * 1.3,
              ),
              onTap: () {
        ...
        children: <Widget>[
          Expanded(
            child: Container(
              ...
              child:
                  autoTextSize('姓名：', TextStyle(color: Colors.black), context),
            ),
          ),
          Expanded(
            flex: 3,
        ...
        children: <Widget>[
          Expanded(
            child: Container(
              ...
              alignment: Alignment.centerLeft,
              child:
                  autoTextSize('手機：', TextStyle(color: Colors.black), context),
            ),
          ),
          Expanded(
            flex: 3,
        ...
        children: <Widget>[
          Expanded(
            child: Container(
              ...
              alignment: Alignment.centerLeft,
              child:
                  autoTextSize('市話：', TextStyle(color: Colors.black), context),
            ),
          ),
          Expanded(
            flex: 3,
        ...
        children: <Widget>[
          InkWell(
            child: Container(
              ...
              child:
                  autoTextSize('新北市', TextStyle(color: Colors.blue), context),
            ),
            onTap: () {},
          ),
          Container(
          ...
          InkWell(
            child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  color: Colors.lightGreen[100]),
              child: autoTextSize(
                  '板橋區'.contains(this.logFullAddress["area"]) == true
                      ? "板橋區"
                      : this.logFullAddress["area"],
          ...
          Container(
            child:
                autoTextSize('鄉鎮市區', TextStyle(color: Colors.black), context),
          ),
        ],
      ),
    ));
          ...
          InkWell(
            child: Container(
              ...
              decoration: BoxDecoration(
                  ...
                  color: Colors.lightGreen[100]),
              child:
                  autoTextSize(roadStr, TextStyle(color: Colors.blue), context),
            ),
            onTap: () {
              FocusScope.of(context).unfocus();
        ...
        children: <Widget>[
          ...
          Flexible(
            ...
            child: Container(
                padding: EdgeInsets.symmetric(horizontal: 10),
                child:
                    autoTextSize('號', TextStyle(color: Colors.black), context)),
          ),
        ],
      ),
    ));
          ...
          children: <Widget>[
            ...
            Flexible(
              ...
              child: Container(
                  padding: EdgeInsets.symmetric(horizontal: 10),
                  child: autoTextSize(
                      '樓 - ', TextStyle(color: Colors.black), context)),
            ),
            Flexible(
              flex: 3,
              child: Container(
    ...
    columnList2.add(Container(
        ...
        child: RichText(
          text: TextSpan(children: <TextSpan>[
            ...
            TextSpan(
              text: this.logMatchAddr["InstallAddessBuildingName"] == null
                  ? ""
                  : this.logMatchAddr["InstallAddessBuildingName"],
              style: TextStyle(
                  color: Colors.red,
                  fontSize: MyScreen.defaultTableCellFontSize(context)),
            )
  ...
  bool _validateSubmit() {
    ...
    if ((_mobileController.text.length == 0) &&
        (_telPhoneController.text.length == 0)) {
